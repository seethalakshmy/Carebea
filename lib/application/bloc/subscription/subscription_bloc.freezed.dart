...
class __$$_GetSubscriptionCopyWithImpl<$Res>
    extends _$SubscriptionEventCopyWithImpl<$Res, _$_GetSubscription>
    implements _$$_GetSubscriptionCopyWith<$Res> {
...
abstract class _GetSubscription implements SubscriptionEvent {
  const factory _GetSubscription(
...
mixin _$SubscriptionState {
  ...
  SubscriptionModel? get response => throw _privateConstructorUsedError;
...
class _$_SubscriptionState implements _SubscriptionState {
  ...
  final bool isError;
  @override
  final SubscriptionModel? response;
  @override
  final String? error;

  @override
  String toString() {
    return 'SubscriptionState(isLoading: $isLoading, isError: $isError, response: $response, error: $error)';
  }
...
abstract class _SubscriptionState implements SubscriptionState {
  const factory _SubscriptionState(
      ...
      required final SubscriptionModel? response,
      required final String? error}) = _$_SubscriptionState;
  ...
  bool get isError;
  @override
  SubscriptionModel? get response;
  @override
  String? get error;
  @override
  @JsonKey(ignore: true)
