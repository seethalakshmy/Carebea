...
class CareGiversEvent with _$CareGiversEvent {
  const factory CareGiversEvent.getCareGivers({required String userId, required int page, required int limit, required int type, String?searchTerm, int?filterId}) = _GetCareGivers;
