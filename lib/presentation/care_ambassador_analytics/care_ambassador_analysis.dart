...
@RoutePage()
class CareAmbassadorAnalysisPage extends StatefulWidget {
  const CareAmbassadorAnalysisPage({
    Key? key,
  }) : super(key: key);

  @override
  State<CareAmbassadorAnalysisPage> createState() =>
      _CareAmbassadorAnalysisPageState();
}

class _CareAmbassadorAnalysisPageState
    extends State<CareAmbassadorAnalysisPage> {
  ...
  /// client and caregiver apis are same only difference is role id since using same bloc
