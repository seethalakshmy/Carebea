...
abstract class $AppRouter extends _i24.RootStackRouter {
  ...
  final Map<String, _i24.PageFactory> pagesMap = {
    ...
    HelpAndSupportRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i11.HelpAndSupportPage(),
      );
    },
    ...
    SupportTicketsDetailRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i19.SupportTicketsDetailPage(),
      );
    },
    TransactionManagementRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i20.TransactionManagementPage(),
      );
    },
    UserManagementRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i21.UserManagementPage(),
      );
    },
    UserManagementDetailRoute.name: (routeData) {
      return _i24.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: const _i22.UserManagementDetailPage(),
      );
    },
...
/// generated route for
/// [_i20.TransactionManagementPage]
