        ...
        leading: Row(
          children: [
                ...
                if (Responsive.isWeb(context) && value) {
                  ...
                  return InkWell(
                    ...
                    child: Container(
                      ...
                      child: CustomImage(path:IMG.colorLogoPng.val,alignment: EAlignment.centerLeft.val,height: 60,width: 166, ),
                    ),
                  );
                }
                return InkWell(
                  ...
                  child: Container(
                    ...
                    child: CustomImage(path:IMG.colorLogoPng.val),
                  ),
                );
              },
            ),
            ...
            MaterialButton(
              ...
              child:  CustomImage( path:  IMG.drawerPng.val,),
            )
          ],
        ),
        actions: [
                  ...
                  Expanded(
                    child: ListTile(
                      ...
                      leading: Padding(
                        ...
                        child: Container(width: 5, color: AppColor.lightBlue.val, height: 30,),
                      ),
                      title: isopen
