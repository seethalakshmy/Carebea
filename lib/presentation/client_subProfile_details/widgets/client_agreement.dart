...
class ClientAgreementView extends StatelessWidget {
  ClientAgreementView({Key? key, required this.state}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    String content = state.response?.data?.serviceAgreement ?? "";
    debugPrint("Agrreeeement $content");
