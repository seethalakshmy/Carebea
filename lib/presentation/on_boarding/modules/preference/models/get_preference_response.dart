...
class GetPreferenceResponse {
  ...
  String? _message;
  Data? _data;
GetPreferenceResponse copyWith({  bool? status,
  String? message,
  Data? data,
}) => GetPreferenceResponse(  status: status ?? _status,
...
LanguagesName languagesNameFromJson(String str) => LanguagesName.fromJson(json.decode(str));
...
class LanguagesName {
  ...
  String? _id;
  String? _name;
LanguagesName copyWith({  String? id,
  String? name,
}) => LanguagesName(  id: id ?? _id,
  name: name ?? _name,
);
  String? get id => _id;
...
PetListName petListNameFromJson(String str) => PetListName.fromJson(json.decode(str));
...
class PetListName {
  ...
  num? _inOutStatus;
  String? _name;
PetListName copyWith({  String? id,
  num? inOutStatus,
  String? name,
}) => PetListName(  id: id ?? _id,
