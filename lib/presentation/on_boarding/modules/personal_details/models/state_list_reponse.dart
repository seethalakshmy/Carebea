import 'dart:convert';
StateListReponse stateListReponseFromJson(String str) => StateListReponse.fromJson(json.decode(str));
String stateListReponseToJson(StateListReponse data) => json.encode(data.toJson());
...
StateListReponse copyWith({  bool? status,
  String? message,
  List<StateItem>? data,
}) => StateListReponse(  status: status ?? _status,
