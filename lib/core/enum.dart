...
enum AppString {
  ...
  reviewPendingByClient("Review Pending By Client"),
  totalOngoingServices("Total Ongoing Services"),
  ...
  careAmbassadorName("Care Ambassador Name"),
  ...
  selectYourStateFirst("Please select  state first"),
  ...
  hhaDocument("Home Health Aide Document"),
  ...
  uploadYourProfilePhoto("Profile Photo"),
  ...
  emptyProfilePic("Please select  profile picture"),
