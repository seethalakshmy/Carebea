...
enum AppString {
  ...
  doYouHaveDifficultyInVision("Do you have difficulty in hearing ?"),
  ...
  successfullyDeleteRole("Successfully delete the role"),
  successfullyUpdateRole("Successfully update the role"),
